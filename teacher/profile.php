...
require("../php/connect.php");
   ...
   $sql="select * from teacher where email_id='$username'" ;
   $res=select_data($sql);
            ...
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <!-- Profile Edit Form -->
                  <form action="../php/tupdate.php" method="post">
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input readonly name="email" type="email" class="form-control" id="Email" value=<?php echo $arr['email_id']; ?>>
                      </div>
                    </div>
